...
--
main = do
   xmproc <- spawnPipe "xmobar -x 0 /home/bezo/.config/xmobar/xmobarrc"
   xmonad $ docks def {
      ...
      -- hooks, layouts
        ...
        logHook            = dynamicLogWithPP xmobarPP
                               ...
                               , ppCurrent = xmobarColor "#e4d9cb" "" . wrap "[ " " ]" -- Current workspace in xmobar
                               , ppVisible = xmobarColor "#e4d9cb" ""                -- Visible but not current workspace
                               , ppHidden = xmobarColor "#e4d9cb" "" . wrap "*" ""   -- Hidden workspaces in xmobar
                               , ppHiddenNoWindows = xmobarColor "#e4d9cb" ""        -- Hidden workspaces (no windows)
                               , ppTitle = xmobarColor "#e4d9cb" "" . shorten 60     -- Title of active window in xmobar
                               --, ppSep =  "<fc=#666666> | </fc>"                     -- Separators in xmobar
                               , ppUrgent = xmobarColor "#e4d9cb" "" . wrap "!" "!"  -- Urgent workspace
